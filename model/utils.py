...
Original file is located at
    https://colab.research.google.com/drive/18aHb6QvNf3jYohlIXIjEZJX86T3WceCx
"""
...
class Argument():
  ...
  def add_args(self):
    self.parser.add_argument('--model_name', type=str, default='kobert-base-v1')
    ...
    self.parser.add_argument('--test_tokenizer', type=str, default='kobert-base-v1')
